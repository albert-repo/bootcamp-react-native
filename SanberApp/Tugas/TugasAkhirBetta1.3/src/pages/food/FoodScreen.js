...
import { View, FlatList, Text, ActivityIndicator, StyleSheet, Image, Alert } from 'react-native';
import { useSelector } from 'react-redux'
import Axios from 'axios';
import { foodApi } from '../../services/index';
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            const res = await Axios.post(
                ...
                console.log('HTTP Error Code : ', e.response.status);
                console.log('HTTP Error Code Message : ', e.response.data.message);
                Alert.alert("Info", e.response.data.message + " (" + e.response.status + ") Please try again later.",
                    [
                        {
                            text: 'OK',
